...
| `unit-tests` | matrixed over worker/api/tool-gateway: `cd backend/<pkg> && ./scripts/pytest_batches.sh` |
| `arch-lint` | matrixed over worker/api/tool-gateway: `make -C backend/<pkg> verify-architecture` |
