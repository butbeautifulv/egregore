...
async def _stub_complete(*, model, messages, temperature, max_tokens):
...
async def test_execute_refuses_output_leakage():
    async def leaking_complete(*, model, messages, temperature, max_tokens):
...
async def test_execute_returns_error_result_when_completion_raises():
    async def failing_complete(*, model, messages, temperature, max_tokens):
...
async def test_execute_uses_command_model_override_over_default():
    ...
    async def recording_complete(*, model, messages, temperature, max_tokens):
