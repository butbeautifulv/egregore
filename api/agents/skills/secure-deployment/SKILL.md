...
description: Hardened deployment patterns for containers, K8s, and minimal production surfaces.
version: "1.0.0"
author: cys-agi
---
...
## Scope
Hardened deployment patterns for containers, K8s, and minimal production surfaces.
